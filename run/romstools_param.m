...
lonmin =  105;   % Minimum longitude [degree east]99 169
lonmax =  125;   % Maximum longitude [degree east]
latmin =  15;   % Minimum latitudeF  [degree north]
latmax =  25;   % Maximum latitude  [degree north]
%
...
%
ROMS_files_dir=[RUN_dir,'ROMS_FILES/South/'];
%
...
%
FORC_DATA_DIR = [RUN_dir,'DATA/South/'];
%
...
Ymax          = 2014;          % last  forcing year
Mmin          = 9;             % first forcing month
Mmax          = 9;             % last  forcing month
%
Dmin          = 10;             % Day of initialization
Hmin          = 12;             % Hour of initialization
...
elseif NCEP_version  == 3
  ...
  if ~exist(NCEP_dir,'file')
    disp(['creat new fold:',NCEP_dir])
    mkdir(NCEP_dir)
  end
...
%-----------------------
%
OGCM        = 'HYCOM';        % Select the OGCM: SODA, ECCO
%
