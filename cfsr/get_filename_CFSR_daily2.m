...
if k==1  
   fname=[Input_dir,'tmp2m.',stryear,strmonth,strday,'.sfluxgrbf.grb2.nc'];
...
elseif k==6    % preticipation
     fname=[Input_dir,'prate.',stryear,strmonth,strday,'.sfluxgrbf.grb2.nc'];
     nc=netcdf(fname,'nowrite');
...
elseif k==7
    fname=[Input_dir,'wnd10m.',stryear,strmonth,strday,'.sfluxgrbf.grb2.nc'];
    nc=netcdf(fname,'nowrite');
...
elseif k==9    
    fname=[Input_dir,'q2m.',stryear,strmonth,strday,'.sfluxgrbf.grb2.nc'];
    nc=netcdf(fname,'nowrite');
...
elseif k==10    
    fname=[Input_dir,'prmsl.',stryear,strmonth,strday,'.pgrbh.grb2.nc'];
    nc=netcdf(fname,'nowrite');
