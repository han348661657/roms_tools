...
if makefrc==1 | makeblk==1
    ...
    elseif Get_My_Data==1
       ...
       % disp(['Use this land file :',char([NCEP_dir,'land_Y',num2str(Ymin),'M',num2str(Mmin),'.nc'])])
        nc=netcdf([NCEP_dir,'Land_cover_0__sea_1__land_surface_Y',num2str(Ymin),'M',num2str(Mmin),'.nc']);
        disp(['Use this land file :',char([NCEP_dir,'Land_cover_0__sea_1__land_surface_Y',num2str(Ymin),'M',num2str(Mmin),'.nc'])])
    end
    ...
    elseif Get_My_Data==1
        mask=1-squeeze(nc{'Land_cover_0__sea_1__land_surface'}(1,:,:));
    end
    mask(mask==0)=NaN;
    close(nc);
    ...
    for Y=Ymin:Ymax
        ...
        for M=mo_min:mo_max
            ...
            elseif Get_My_Data==1
                nc=netcdf([NCEP_dir,'Precipitation_rate_surface_0_Hour_Average_Y',num2str(Y),'M',num2str(M),'.nc']);
            end
            ...
            elseif Get_My_Data==1
                fname = [NCEP_dir,'Precipitation_rate_surface_0_Hour_Average_Y',num2str(Ym),'M',num2str(Mm),'.nc'];
            ...
            elseif Get_My_Data==1
                fname=[NCEP_dir,'Precipitation_rate_surface_0_Hour_Average_Y',num2str(Yp),'M',num2str(Mp),'.nc'];
            end
