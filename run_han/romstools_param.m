...
latmax = -30;   % Maximum latitude  [degree north]
%
...
%
FORC_DATA_DIR =[RUN_dir,'ROMS_FILES\'];
%
% eval(['!mkdir ',ROMS_files_dir])
%
% ROMS file names (grid, forcing, bulk, climatology, initial)
%
if ~exist(ROMS_files_dir,'dir')
    mkdir(ROMS_files_dir)
end
...
timezone = +8;                            % Local time= UTC + timezone
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
